...
const HorizontalProcess = () => {
  ...
  const x = useTransform(smoothProgress, [0, 0.05, 0.2, 0.4, 0.55, 0.75, 0.85, 1], ["0vw", "0vw", "-100vw", "-100vw", "-200vw", "-200vw", "-300vw", "-300vw"]);
    ...
    >
      ...
      <div className={`${isVertical ? 'relative' : 'sticky top-0 h-screen w-full flex items-center dark:border-t-2 dark:border-orange-700 overflow-hidden'}`}>
        ...
        <div className={`${isVertical ? 'relative mb-16' : 'absolute top-20 left-0 w-full z-20 pointer-events-none'}`}>
          <div className="text-center px-4">
            ...
            <FadeIn direction="up" delay={0.2}>
              <h2 className="text-3xl md:text-5xl lg:text-6xl dark:text-white font-black text-slate-900 uppercase">
        ...
        <motion.div 
          ...
          className={`flex ${isVertical ? 'flex-col px-6 gap-24 sm:gap-32' : 'will-change-transform'}`}
        >
          {sections.map((item) => (
            <div 
              key={item.id} 
            ...
            >
              ...
              <div className="z-10 w-full lg:w-1/2 mb-10 lg:mb-0 text-center lg:text-left">
                <FadeIn direction={isVertical ? "up" : "right"}>
                  <span className="text-[#B54118] font-bold tracking-[0.3em] uppercase
