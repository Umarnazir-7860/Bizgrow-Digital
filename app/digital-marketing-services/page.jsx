  ...
  const marketingServices = [
    {
      ...
      desc: <>Drives more visitors to your website through increasing visibility in <Link href="https://bizgrow-digital.co.uk/how-can-expert-seo-techniques-boost-your-business-visibility/ " className="text-[#B54118] font-bold underline">search engines</Link>  (e.g., Google) and generating quality traffic from your target customers.</>,
      // Search icon SEO ke liye perfect hai
      icon: <Search className="w-8 h-8" />,
    },
    {
      title: "Social Media Marketing (SMM)",
      desc: <>Create Brand Awareness, interact with your audience, and develop a social community across multiple <Link href="https://bizgrow-digital.co.uk/what-are-the-4-stages-of-social-media-marketing/ " className="text-[#B54118] font-bold underline">Social Media</Link> Platforms (e.g., Facebook, Instagram, and LinkedIn).</>,
    ...
    },
    {
      ...
      desc: <>We  <Link href="https://bizgrow-digital.co.uk/what-is-web-design-the-ultimate-guide-to-designing-a-website/" className="text-[#B54118] font-bold underline">design and develop</Link> fast, secure, and user-friendly websites to reflect the identity of your brand and its Marketing Goals while providing a quality user experience.</>,
