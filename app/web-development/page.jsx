...
const WebDevelopmentPage = () => {
  const techStack = [
    ...
    {
      title: "Tailwind CSS",
      desc: <><Link href="https://bizgrow-digital.co.uk/graphic-design-services/" className="text-[#B54118] font-bold underline">Delivering clean, responsive designs</Link> with a utility-first framework for consistent styling and fast, scalable development.</>,
            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {[
                  ...
                  <Link href="https://bizgrow-digital.co.uk/how-can-expert-seo-techniques-boost-your-business-visibility/" className="underline font-bold decoration-[#B54118]">SEO-Optimised Structure</Link>,
                  "Mobile-First Design",
