...
import { Globe, Palette, TrendingUp, Megaphone, Fingerprint,  PenTool } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service, index) => (
              ...
              >
                <div
                  className={`w-16 h-16 ${service.bgColor} ${service.hoverBg} ${service.hoverIcon} rounded-2xl 
          ...
          duration-300 group-hover:rotate-12`}
                ...
                <h3
                  className="text-2xl font-bold text-slate-800 dark:text-white mb-4 transition-colors 
          group-hover:text-[#B54118]"
                >
                  {service.title}
                </h3>
                <p className="text-gray-600  dark:text-white leading-relaxed">{service.desc}</p>
              </div>
              </FadeIn>
            ))}
          </div>
